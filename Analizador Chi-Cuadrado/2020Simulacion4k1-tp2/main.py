...
url_main_folder = './'
# url_main_folder = 'C:\Users\jose_\OneDrive\Escritorio\Jose\Facultad\GitHub\TP3-SIM\GeneradorDeDistribuciones\\bin\Debug\\'
# url_tests_files_folder = f'{url_main_folder}test_files/'
url_export_files_folder = f'{url_main_folder}exports_files/'
filename = f'{url_main_folder}test_files/data.txt'
...
xls_name = f'{url_export_files_folder}test_chi2_'
